                ...
                <div class="relative px-4 sm:px-8 lg:px-12">
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="max-w-2xl">
                            ...
                            <h1 class="text-3xl tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-4xl font-thin">Bhavya Patel - Full Stack Developer, Software Developer &amp; Tech Enthusiast</h1>
                            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400 font-thin">
                            ...
                            <a class="group -m-1 p-1" href="https://twitter.com/bhavyapatel94">
                            ...
                            <a class="group -m-1 p-1" href="https://www.instagram.com/bhavya_splendid94">
                                <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                            ...
                            <a class="group -m-1 p-1" href="https://github.com/BhavyaMPatel">
                                <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                            ...
                            <a class="group -m-1 p-1" href="https://www.linkedin.com/in/bhavyapatel94">
                            ...
                            <a class="group -m-1 p-1" href="https://stackoverflow.com/users/17952976/bhavyampatel">
                                <svg viewBox="0 0 24 24" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
