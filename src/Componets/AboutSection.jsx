...
export default function AboutSection() {
    return (
        <>  
            <Helmet>   
                <title>BhavyaMPatel | Home About Page</title>
                ...
                <link rel="canonical" href="https://bhavyapatel.vercel.app/" />
            </Helmet>
                ...
                <div className="relative px-4 sm:px-8 lg:px-12">
                    <div className="mx-auto max-w-2xl lg:max-w-5xl">
                        <div className="max-w-2xl">
                            ...
                            <a href="https://twitter.com/bhavyapatel94" className="group -m-1 p-1">
                            ...
                            <a href="https://www.instagram.com/bhavya_splendid94" className="group -m-1 p-1">
                                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                            ...
                            <a href="https://github.com/BhavyaMPatel" className="group -m-1 p-1" >
                                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                            ...
                            <a  href="https://www.linkedin.com/in/bhavyapatel94" className="group -m-1 p-1">
                            ...
                            <a href="https://stackoverflow.com/users/17952976/bhavyampatel" className="group -m-1 p-1" >
                                <svg viewBox="0 0 24 24" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
